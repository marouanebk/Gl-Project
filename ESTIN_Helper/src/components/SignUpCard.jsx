        ...
        <form onSubmit={handSubmit}>
          <div className=" items-center flex flex-wrap sm:justify-start justify-center w-full relative">
              <div className="flex justify-start items-center mb-8 m-0">
                  ...
                  <input className="border-none bg-black-gradient rounded-[50px] h-12 w-[95%] p-8 pl-14 text-white" type="text" name="first_name" onChange={e=>setFirstName(e.target.value)} id="first_name" placeholder="First Name"/>
              </div>
              <div className="flex justify-start items-center relative mb-8">
                  <img src={facebook} className="absolute ml-4 w-8" alt="Age icon"/>
                  <input className="border-none bg-black-gradient rounded-[50px] h-12 w-[95%] p-8 pl-14 text-white" type="text" name="last_name" id="last_name" onChange={e=>setLastName(e.target.value)} placeholder="Last Name"/>
              </div>
              <div className="flex justify-start items-center mb-8 m-0">
              ...
              <div className="flex justify-start items-center mb-8 m-0">
                  ...
                  <input className="border-none bg-black-gradient rounded-[50px] h-12 w-[95%] p-8 pl-14 text-white" type="text" name="phone" id="phone" onChange={e=>setPhone(e.target.value)} placeholder="Phone number"/>
              </div>
              <div className="flex justify-start items-center mb-8 m-0">
                  <img src={facebook} className="absolute ml-4 w-8" alt="Password icon"/>
                  <input className="border-none bg-black-gradient rounded-[50px] h-12 w-[95%] p-8 pl-14 text-white" type="password" name="password" id="password" onChange={e=>setPassword(e.target.value)} placeholder="Password"/>
              </div>
              <div className="flex justify-start items-center mb-8 m-0">
                  <img src={facebook} className="absolute ml-4 w-8" alt="Country icon"/>
                  <input className="border-none bg-black-gradient rounded-[50px] h-12 w-[95%] p-8 pl-14 text-white" type="text" name="address" id="address" onChange={e=>setAddress(e.target.value)} placeholder="Address"/>
              </div>
              <div className="flex justify-start items-center mb-12 m-0">
                  ...
                  <input className="border-none bg-black-gradient rounded-[50px] h-12 w-[95%] p-8 pl-14 text-white" type="password" name="password2" id="password2" onChange={e=>setPassword2(e.target.value)} placeholder="Confirm password"/>
              </div>
