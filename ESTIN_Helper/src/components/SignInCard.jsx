...
import { email, facebook, google, key, profile } from "../assets/index.js";
import "../index.css"
        ...
        <center>
          ...
          <form onSubmit={loginUser}>
            <div className="flex justify-start items-center mb-8 min-w-[0] sm:min-w-[450px]">
              <img src={email} className="absolute ml-4 w-8" alt="Email icon" />
            ...
            <button style={{ cursor: "pointer" }} className={`${styles.paragraph} mt-4 pt-4 pb-4 pl-8 pr-8 mb-0 font-poppins text-primary font-medium cursor-pointer text-[18px] items-start bg-blue-gradient rounded-[30px]`} type='submit' > Sign in</button>
          </form>
